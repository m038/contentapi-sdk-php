...
class ItemAdapterSpec extends ObjectBehavior
{
    ...
    function let(ClientInterface $client, PaginationDecorator $paginationRequest)
    {
        $this->beConstructedWith($client, $paginationRequest);
    }

    function its_method_get_slice_should_return_items($client, $paginationRequest)
    {
